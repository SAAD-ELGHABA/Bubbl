...
const MessagesPage = () => {
  ...
  const messages = {
    1: [
      ...
      {
        id: 3,
        text: "Pretty good. Just finished my morning coffee ☕",
        sender: "them",
        time: "10:28 AM",
      },
      {
        id: 4,
        text: "Nice! What kind of project are you working on?",
        sender: "them",
        time: "10:29 AM",
      },
      {
        id: 5,
        text: "It's a chat application using React and Node.js. It's coming along nicely!",
        sender: "me",
        time: "10:30 AM",
      },
      {
    ...
    2: [
      {
        id: 1,
        text: "Hi, do you have the meeting agenda for tomorrow?",
        sender: "them",
        time: "9:10 AM",
      },
      {
        id: 2,
        text: "Yes, I'll send it over in a bit.",
        sender: "me",
        time: "9:12 AM",
      },
      {
        id: 3,
        text: "Great, thanks! Looking forward to our discussion.",
        sender: "them",
        time: "9:15 AM",
      },
    ],
    3: [
      {
        id: 1,
        text: "Did you get a chance to review the new project specs?",
        sender: "them",
        time: "Yesterday",
      },
      {
        id: 2,
        text: "Not yet, I'll take a look today.",
        sender: "me",
        time: "Yesterday",
      },
      {
      ...
      <div className="w-full md:w-80 bg-white flex flex-col border-r border-[#85C4E4]">
        ...
        <div className="p-4 bg-gradient-to-r from-[#02182E] to-[#022F56] text-white">
          ...
          <div className="relative mt-3">
            <Search
              className="absolute left-3 top-1/2 transform -translate-y-1/2 text-[#85C4E4]"
              size={18}
            />
            <input
              type="text"
        ...
        <div className="flex-1 overflow-y-auto">
          {conversations?.length > 0 ? (
            conversations.map((conversation) => (
              <div
                key={conversation.id}
                className={`flex items-center p-4 border-b border-[#CCDEE4] cursor-pointer transition-all ${
                  activeConversation === conversation.id
                    ? "bg-[#85C4E4] bg-opacity-20"
                    : "hover:bg-[#CCDEE4] hover:bg-opacity-30"
                }`}
              ...
              >
                ...
                <div className="ml-3 flex-1 min-w-0">
                  <div className="flex justify-between items-center">
                    <h3 className="font-semibold text-[#02182E] truncate">
                      {conversation.name}
                    </h3>
                    <span className="text-xs text-[#488DB4]">
                      {conversation.time}
                    </span>
                  </div>
                  <p className="text-sm text-[#488DB4] truncate">
            ...
            <div className="flex flex-col items-center gap-4 justify-center h-full">
              ...
              <Link className="underline flex items-center gap-2"
              to={'/me/profile/friends'}
              >
                <CornerUpLeft />
                <span>Go And Get Friends</span>
              </Link>
            </div>
          )}
        </div>
        ...
        {activeConvData ? (
          <div className="bg-white p-4 border-b border-[#85C4E4] flex items-center justify-between">
            <div className="flex items-center">
              ...
              <div className="ml-3">
                <h2 className="font-semibold text-[#02182E]">
                  {activeConvData.name}
                </h2>
        ...
        {activeConvData && (
          <div className="bg-white p-4 border-t border-[#85C4E4]">
            <form onSubmit={handleSendMessage} className="flex items-center">
              <button
                type="button"
                className="text-[#488DB4] hover:text-[#022F56] p-2"
              >
                <Paperclip size={20} />
              </button>
              <button
          ...
          <>
            ...
            <div className="p-4 bg-gradient-to-r from-[#02182E] to-[#022F56] text-white">
              <div className="flex items-center mb-3 justify-between">
                <Link
                  to={PROFILE}
                  className="text-sm text-[#85C4E4]  inline-block"
                >
