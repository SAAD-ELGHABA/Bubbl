    ...
    return (
        <div className='w-full overflow-hidden h-full'>
            <div className="bg-gradient-to-r from-[#02182E] to-[#022F56] p-3 mb-4 text-white">
                ...
                <p className="text-[#85C4E4]">Manage your profile and account preferences</p>
            </div>
                                ...
                                <div className="space-y-2">
                                    <div className="flex items-center justify-between p-3 border border-gray-200 rounded-lg">
                                        ...
                                        <button
                                            ...
                                            className="text-[#488DB4] hover:underline cursor-pointer">Edit</button>
                                    </div>
                                    <div className="flex items-center justify-between p-3 border border-gray-200 rounded-lg">
                                        <span>Change Password</span>
                                        <button
                                            onClick={() => setSettingTarget('password')}
                                            className="text-[#488DB4] hover:underline cursor-pointer">Change</button>
                                    </div>
                                    <div className="flex items-center justify-between p-3 border border-gray-200 rounded-lg">
                                        <span>Privacy Settings</span>
                                        <button
                                            onClick={() => setSettingTarget('privacy')}
                                            className="text-[#488DB4] hover:underline cursor-pointer">Manage</button>
                                    </div>
                                </div>
                            </div>
