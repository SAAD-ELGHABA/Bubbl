export const verificationEmailTemplate = ({ name, verificationUrl }) => {
    return `
        <div style="
            ...
            padding: 20px;
            border-radius: 10px;
            background: linear-gradient(135deg, #001219, #005f73, #0a9396, #94d2bd, #e9d8a6, #ee9b00, #ca6702, #bb3e03, #ae2012, #9b2226);
            color: #f0f0f0;
        ">
            <!-- White Container -->
            <div style="
                ...
                margin-bottom: 20px;
                text-align: center;
                color: #001219; /* Dark text for readability */
            ">
                <!-- Logo -->
                ...
                <!-- Footer -->
                <p style="font-size: 16px; color: #555555;">Thanks,<br/>Bubbl Dream Team</p>
            </div>
        </div>
    `;
};
